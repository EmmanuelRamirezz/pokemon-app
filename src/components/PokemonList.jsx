        ...
        loading ? (
          ...
          (
            <div>
              {vista ? (
                <>
                <div className="border-2 border-sky-600 bg-gray-100 mt-36 flex  justify-evenly w-3/4 mx-auto max-xl:w-11/12">
                  <div className="border border-black w-1/4 text-center">Imagen</div>
                  <div className="border border-black w-1/4 text-center max-sm:w-[20%]">Numero</div>
                  <div className="border border-black w-1/4 text-center max-sm:w-[30%]">Nombre</div>
                  <div className="border border-black w-1/4 text-center">Tipo</div>
                </div>
