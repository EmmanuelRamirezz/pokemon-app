  ...
  return (
    <Link to={`/pokemon/${pokemon.id}`}
      className="flex bg-gray-100 hover:bg-gray-200">
        ...
        <div className="w-1/4 border border-sky-600">
        ...
        <div className="flex items-center w-1/4 border border-sky-600 max-sm:w-[20%]">
          <h3 className="text-gray-400 mx-auto">No. {pokemon.id}</h3>
        </div>


        <div className="flex items-center w-1/4 border border-sky-600 max-sm:w-[30%]">
          <h3 className="font-bold text-lg mx-auto">{primerMayuscula(pokemon.name)}</h3>
        </div>


        <div className=" flex items-center w-1/4 border border-sky-600 max-md:flex-col max-md:justify-evenly">
